      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-neutral-800 pb-4">
        <div>
          ...
          <p className="text-xs text-neutral-400 mt-1">
            Konfigurasi tarif sesi 90 menit tanpa biaya tersembunyi dan kelola voucher promosi.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <div className="p-6 rounded-2xl bg-neutral-900/70 border border-neutral-800 space-y-5">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-semibold text-white text-base">Tarif Flat Layanan</h2>
            </div>
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="p-4 bg-neutral-950 rounded-xl border border-neutral-800 space-y-2">
                <div className="flex justify-between items-center">
                  <span className="font-medium text-white">Konselor Sebaya</span>
                ...
                <input
                  ...
                  className="w-full bg-neutral-900 border border-neutral-700 rounded-lg px-3 py-1.5 text-xs text-neutral-200 mt-1"
                />
              </div>
              ...
              <div className="p-4 bg-neutral-950 rounded-xl border border-neutral-800 space-y-2">
                <div className="flex justify-between items-center">
                  <span className="font-medium text-white">Psikolog Klinis (STR)</span>
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-medium text-xs transition-colors cursor-pointer"
            >
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="p-4 rounded-2xl bg-neutral-900/60 border border-neutral-800 text-xs text-neutral-300 flex items-start gap-3">
            ...
            <div>
              <strong className="text-white">Mekanisme Voucher Hold & Rollback Atomik (ADR-0002):</strong>{" "}
            ...
            <table className="w-full text-left text-xs">
              <thead className="bg-neutral-900/80 border-b border-neutral-800 text-neutral-400 font-medium">
                <tr>
                  ...
                  <th className="py-3 px-3">Potongan Diskon</th>
                  <th className="py-3 px-3">Kuota Pemakaian</th>
              ...
              <tbody className="divide-y divide-neutral-800/60">
                {vouchers.map((v) => {
                  ...
                  return (
                    <tr key={v.code} className="hover:bg-neutral-800/30 transition-colors">
                      <td className="py-3.5 px-4">
                        <div className="font-mono font-bold text-emerald-400 text-sm">
                          {v.code}
                        </div>
                      </td>
                      <td className="py-3 px-3 font-medium text-white">{v.discount}</td>
                      <td className="py-3 px-3">
                        ...
                        <div className="w-28 h-1.5 bg-neutral-800 rounded-full mt-1 overflow-hidden">
                          <div
                            className={`h-full rounded-full ${
                              percent >= 100 ? "bg-rose-500" : "bg-emerald-400"
                            }`}
                            style={{ width: `${Math.min(percent, 100)}%` }}
                          />
                        </div>
                      </td>
                      <td className="py-3 px-3 text-neutral-400">{v.expiryDate}</td>
                      <td className="py-3 px-3">
                        <span
                      ...
                      <td className="py-3 px-4 text-right">
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg bg-neutral-800 hover:bg-neutral-700 text-neutral-300 text-[11px] transition-colors cursor-pointer border border-neutral-700"
                        >
                          Nonaktifkan
                        </button>
                      </td>
        ...
        <div className="fixed inset-0 bg-neutral-950/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="flex items-center justify-between border-b border-neutral-800 pb-3">
              <h3 className="font-semibold text-white text-sm">Terbitkan Kode Voucher Baru</h3>
              <button
                type="button"
            ...
            <div className="space-y-3 text-xs">
              <div>
                <label className="text-neutral-300 font-medium">Kode Kupon (Uppercase):</label>
                <input
                  type="text"
                  ...
                  required
                  className="w-full bg-neutral-950 border border-neutral-700 rounded-xl px-3 py-2 text-xs text-white font-mono uppercase mt-1 focus:outline-none focus:border-emerald-500"
                />
              </div>

              <div>
                <label className="text-neutral-300 font-medium">Potongan / Keterangan:</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-neutral-300 font-medium">Batas Kuota Pemakaian:</label>
                <input
                  type="number"
                  placeholder="50"
                  value={newQuota}
